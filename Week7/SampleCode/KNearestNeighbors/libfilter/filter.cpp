...
Platform::Array<float>^ Filter::filter( const Platform::Array<float>^ data ) {
	Platform::Array<float>^ result = ref new Platform::Array<float>(data->Length);
...
Platform::Array<float>^ Filter::getImpulseResponse() {
	return ref new Platform::Array<float>(this->impulseResponse, this->N);
}

/*
void Filter::updateImpulseResponse( const Platform::Array<float>^ impulseResponse ) {
